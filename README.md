![docker image](https://github.com/FAIRmat-NFDI/nomad-distro-oasis-b/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/FAIRmat-NFDI/nomad-distro-oasis-b.git
    cd nomad-distro-oasis-b
    ```

    or

    ```sh
    curl-L -o nomad-distro-oasis-b.zip "https://github.com/FAIRmat-NFDI/nomad-distro-oasis-b/archive/main.zip"
    unzip nomad-distro-oasis-b.zip
    cd nomad-distro-oasis-b
    ```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/FAIRmat-NFDI/nomad-distro-oasis-b/manifests/main": unauthorized`
